...
DOGOVOR_RUSSIAN_ALIASES = {
    ...
    'номер регистрации': 'registration_number', 'брд': 'registration_number',
    'дата документа': 'document_date',
    'номер дс': 'additional_number', 'доп.соглашение': 'additional_number',
    'дата дс': 'additional_date',
    'раздел услуг': 'service_section', 'услуг': 'service_section',
    'объект': 'service_subtype', 'вид работ': 'service_subtype', 'работ': 'service_subtype',
    'кратко': 'brief_subject', 'краткая тема': 'brief_subject', 'тема документа': 'brief_subject',
    'место заключения': 'place_conclusion', 'город': 'place_conclusion',
    'место оказания': 'place_service',
    'инициатор': 'initiator',
    'игк': 'government_id', 'госконтракт': 'government_id',
    'форма расчета': 'payment_form', 'расчет': 'payment_form',
    'статус оригинала': 'original_status', 'оригинал': 'original_status',
    'исх': 'outgoing_info', 'исходящий': 'outgoing_info', 'письмо': 'outgoing_info',
    'подписант': 'signatory', 'подписывает': 'signatory',
    'полномочий': 'signatory_doc', 'доверенность': 'signatory_doc',
    'реквизиты': 'counterparty_details',
    'электронная копия': 'electronic_copy', 'скан': 'electronic_copy', 'копия': 'electronic_copy',
    'пролонгация': 'prolongation', 'продление': 'prolongation',
    'срок до пролонгации': 'prolongation_days',
    'продление требуется': 'renewal_required', 'нужно продление': 'renewal_required',
    'дог.начало': 'planned_start', 'план начало': 'planned_start',
    'дог.оконч': 'planned_end', 'план окончание': 'planned_end',
    'факт.нач': 'actual_start', 'факт начало': 'actual_start',
    'факт.оконч': 'actual_end', 'факт окончание': 'actual_end',
    'срок действия': 'validity_period',
    'в мес': 'monthly_amount', 'в месяц': 'monthly_amount',
    'без налога': 'amount_no_tax',
    'налог %': 'tax_rate', 'налог': 'tax_rate', 'ндс': 'tax_rate',
    'с налогом': 'amount_with_tax',
    'оплачено': 'amount_paid',
    'осталось': 'amount_remaining', 'остаток': 'amount_remaining',
    'отправки': 'date_sent_to_sign', 'на подпись': 'date_sent_to_sign',
    'получения': 'date_received_signed', 'от контрагента': 'date_received_signed',
    'расторжения': 'termination_date', 'расторгнут': 'termination_date',
}
